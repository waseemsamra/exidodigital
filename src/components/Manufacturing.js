          ...
          <div className="container mx-auto px-8 relative z-20">
            <div className="max-w-3xl">
              ...
              <p className="font-body text-xl text-on-surface-variant max-w-xl leading-relaxed mb-10">
                Deploy Bluechip's neural mesh to transform legacy hardware into a living, breathing industrial ecosystem. Real-time cognitive manufacturing starts here.
              </p>
          ...
          <div className="container mx-auto px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                ...
                <p className="text-on-surface-variant text-lg leading-relaxed mb-10">Extend your factory intelligence beyond the walls. Bluechip synchronizes raw material intake with live production pacing and global logistics demand.</p>
                <div className="space-y-6">
        ...
        <section className="py-24 bg-gradient-to-t from-surface-container-high to-surface border-t border-outline-variant/10">
          <div className="container mx-auto px-8 text-center">
            ...
            <p className="text-on-surface-variant text-xl max-w-2xl mx-auto mb-12">
              Connect your assets to Bluechip. Join the vanguard of autonomous manufacturing today.
            </p>
