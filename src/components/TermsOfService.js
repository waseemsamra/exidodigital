        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 text-center md:text-left">
            ...
            <p className="text-on-surface-variant text-lg leading-relaxed max-w-2xl font-body mx-auto md:mx-0">
              Welcome to Bluechip. These terms govern your use of our digital infrastructure, cloud architecture, and data-driven authority platforms. By accessing our console, you agree to the protocols outlined below.
            </p>
          </div>
          ...
          <div className="space-y-12">
            ...
            <section className="p-8 md:p-12 rounded-xl bg-surface-container-low relative overflow-hidden" id="introduction">
              ...
              <div className="space-y-6 text-on-surface-variant text-lg leading-relaxed">
                <p>Bluechip provides advanced computational environments and real-time data orchestration services. These Terms of Service ("Terms") constitute a legally binding agreement between you and Bluechip regarding your access to and use of the services.</p>
            ...
            <section className="p-8 md:p-12 rounded-xl bg-surface-container-low border-l-4 border-primary" id="service-provision">
              ...
              <div className="space-y-6 text-on-surface-variant text-lg leading-relaxed">
                <p>Bluechip grants you a non-exclusive, non-transferable, revocable license to access and use our platform strictly in accordance with these Terms. We reserve the right to withdraw or amend this service, and any service or material we provide on the platform, in our sole discretion without notice.</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <ul className="space-y-3 text-on-surface-variant font-body">
                  <li className="flex items-center gap-2">
                    ...
                    Reverse engineering of proprietary Bluechip-logic.
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-primary"></span>
            ...
            <section className="p-8 md:p-12 rounded-xl bg-surface-container-lowest border border-outline-variant/15" id="governing-law">
              ...
              <div className="text-on-surface-variant text-lg leading-relaxed">
                <p>All matters relating to the Website and these Terms of Use and any dispute or claim arising therefrom or related thereto (in each case, including non-contractual disputes or claims), shall be governed by and construed in accordance with the internal laws of the jurisdiction where Bluechip is headquartered, without giving effect to any choice or conflict of law provision or rule.</p>
              </div>
            </section>
            ...
            <div className="p-12 rounded-xl bg-gradient-to-br from-surface-container-high to-surface-container-low border border-outline-variant/10 text-center">
              ...
              <a href="mailto:legal@bluechipdigital.com" className="inline-block bg-surface-container-highest border border-outline-variant/30 text-primary px-8 py-3 rounded-lg font-bold text-xs uppercase tracking-widest hover:bg-surface-bright transition-all">
                Contact Compliance
              </a>
            </div>
          </div>
