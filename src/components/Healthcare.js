            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-on-surface-variant text-lg leading-relaxed mb-8">
                  Bluechip provides a zero-trust architecture for health information exchanges. Our Data Lakes allow for anonymized, collaborative research at massive scale without compromising individual patient privacy.
                </p>
        ...
        <section className="py-24 px-8 max-w-screen-2xl mx-auto">
          ...
          <div className="mt-20 relative rounded-3xl overflow-hidden min-h-[400px] flex items-center px-12">
            ...
            <div className="relative z-10 max-w-2xl">
              ...
              <p className="text-on-surface-variant mb-8 text-lg">Partner with Bluechip to build the next generation of life-saving digital infrastructure.</p>
