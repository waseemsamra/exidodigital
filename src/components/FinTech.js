            ...
            <div className="grid md:grid-cols-2 gap-20 items-center">
              <div className="space-y-8">
                ...
                <p className="text-on-surface-variant text-lg leading-relaxed">
                  Moving beyond reactive filters. Bluechip implements AI-driven predictive modeling at the edge, identifying malicious patterns before the handshake is even complete.
                </p>
