          ...
          <div className="max-w-7xl mx-auto px-8 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10">
            <div className="lg:col-span-8 flex flex-col justify-center">
              ...
              <p className="text-on-surface-variant text-xl max-w-2xl mb-12 leading-relaxed">
                Bluechip powers global retail through high-fidelity headless engines and neural personalization. We don't just process transactions; we engineer digital experiences that convert.
              </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-20">
            ...
            <div>
              ...
              <p className="text-on-surface-variant text-lg mb-8 leading-relaxed">
                Eliminate overselling and stockouts with our sub-second synchronization engine. Bluechip tracks every movement from the warehouse shelf to the customer's cart in real-time.
              </p>
        ...
        <section className="py-32 px-8 bg-surface-container-low overflow-hidden relative">
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <p className="text-on-surface-variant text-lg">Hyper-relevant shopping experiences at scale. Bluechip analyzes 200+ intent signals to deliver the right product at the exact millisecond of interest.</p>
            </div>
