            ...
            <div className="lg:col-span-7">
              <div className="glass-panel p-8 md:p-12 rounded-2xl shadow-2xl relative overflow-hidden">
                ...
                <form className="space-y-8 relative z-10">
                  ...
                  <button 
                    type="submit"
                    className="w-full bg-gradient-to-r from-primary to-primary-container text-on-primary font-bold py-5 rounded-lg text-sm uppercase tracking-widest hover:btn-glow active:scale-[0.98] transition-all group flex items-center justify-center gap-3"
                  >
