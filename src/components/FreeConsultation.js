        ...
        <section className="relative min-h-[614px] flex flex-col justify-center items-center pt-24 pb-12 overflow-hidden bg-mesh-hero">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            <div className="inline-block mb-6">
              <span className="font-headline text-xs tracking-[0.2em] font-extrabold uppercase text-secondary px-4 py-1.5 border border-secondary/20 rounded-full bg-secondary/5">Free Consultation</span>
            </div>
            <h1 className="font-headline text-6xl md:text-8xl font-black tracking-tighter text-on-surface mb-6 leading-none">
              Initialize Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Free Consultation</span>
            </h1>
            ...
            <div className="lg:col-span-5 space-y-12">
              <div>
                ...
                <p className="text-on-surface-variant text-lg leading-relaxed">
                  Every collaboration begins with a precise assessment of digital infrastructure needs. Complete the secure initialization sequence below to begin your free consultation.
                </p>
              </div>
